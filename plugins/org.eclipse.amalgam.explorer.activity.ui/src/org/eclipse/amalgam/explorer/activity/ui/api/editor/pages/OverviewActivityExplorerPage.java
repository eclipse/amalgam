...
/**
 * Overview page that behaves as a Activity Explorer. That displays navigable links to other pages.
 * 
 */
  ...
  public Composite createSubForm(IManagedForm managedForm, Composite body, CommonActivityExplorerPage page) {
    ...
    if (page.isVisible()) {
      ...
      if (!(txt == null || txt.isEmpty())) {
        ...
        richText = FormHelper.createRichText(managedForm.getToolkit(), composite, txt, new OverviewPageLinkAdapter(
            getEditor()));
