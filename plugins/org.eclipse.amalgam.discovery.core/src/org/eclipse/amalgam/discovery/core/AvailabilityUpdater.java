...
import org.eclipse.amalgam.discovery.ModelingDiscoveryCoreActivator;
...
public class AvailabilityUpdater {
    ...
    public void update(IProgressMonitor monitor) {
        ...
        Collection<InstallableComponent> connectors = discovery.getAllInstallableComponents();
                        ...
                        try {
                            for (;;) {
                                try {
                                    ...
                                    Collection<InstallableComponent> descriptors = urlToDescriptors.get(job.url);
                            ...
                            if (e.getCause() instanceof CoreException) {
                                ...
                                status = new Status(IStatus.ERROR, ModelingDiscoveryCoreActivator.PLUGIN_ID, "Error while checking update sites availability.", e.getCause());
                            }
                        }
                        monitor.worked(1);
                    }
