 ...
 * </copyright>
 *
 * $Id: MindmapSwitch.java,v 1.1 2008/11/14 17:33:36 rgronback Exp $
 */
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case MindmapPackage.TOPIC: {
				...
				if (result == null) result = caseMapElement(topic);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MindmapPackage.RELATIONSHIP: {
				...
				if (result == null) result = caseMapElement(relationship);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
