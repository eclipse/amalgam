 ...
 * @generated
 */
public class RequirementGroupRequirementsCreateCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public RequirementGroupRequirementsCreateCommand(
	...
	public boolean canExecute() {
		...
		return RequirementsBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateRequirementGroupRequirements_4001(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getRequirements().add(getTarget());
		}
