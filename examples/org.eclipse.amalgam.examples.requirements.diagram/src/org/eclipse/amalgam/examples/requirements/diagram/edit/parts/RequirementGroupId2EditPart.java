 ...
 * @generated
 */
public class RequirementGroupId2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public RequirementGroupId2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new RequirementsParserProvider.HintAdapter(
					RequirementsElementTypes.RequirementGroup_2003,
