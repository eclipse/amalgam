 ...
 * @generated
 */
public class RequirementDependenciesReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public RequirementDependenciesReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return RequirementsBaseItemSemanticEditPolicy.LinkConstraints
				.canExistRequirementDependencies_4003(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return RequirementsBaseItemSemanticEditPolicy.LinkConstraints
				.canExistRequirementDependencies_4003(getOldSource(),
						getNewTarget());
	}
