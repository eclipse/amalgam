 ...
 * @generated
 */
public class RequirementGroupRequirementsReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public RequirementGroupRequirementsReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Requirement && newEnd instanceof RequirementGroup)) {
			return false;
		}
		return RequirementsBaseItemSemanticEditPolicy.LinkConstraints
				.canExistRequirementGroupRequirements_4001(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return RequirementsBaseItemSemanticEditPolicy.LinkConstraints
				.canExistRequirementGroupRequirements_4001(getOldSource(),
						getNewTarget());
	}
