...
import org.eclipse.amalgam.examples.requirements.diagram.edit.policies.RequirementsTextSelectionEditPolicy;
 ...
 * @generated
 */
public class RequirementIdEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				RequirementsVisualIDRegistry
						.getType(org.eclipse.amalgam.examples.requirements.diagram.edit.parts.RequirementIdEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public RequirementIdEditPart(View view) {
		super(view);
	}
	...
	public void setLabelText(String text) {
		...
		if (pdEditPolicy instanceof RequirementsTextSelectionEditPolicy) {
			((RequirementsTextSelectionEditPolicy) pdEditPolicy)
					.refreshFeedback();
		}
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, TextDirectEditManager
					.getTextCellEditorClass(this), RequirementsEditPartFactory
