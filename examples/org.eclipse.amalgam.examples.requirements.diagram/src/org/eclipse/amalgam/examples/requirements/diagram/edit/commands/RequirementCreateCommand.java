 ...
 * @generated
 */
public class RequirementCreateCommand extends CreateElementCommand {

	/**
	 * @generated
	 */
	public RequirementCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		RequirementsElementTypes.init_Requirement_2002(newElement);
		return newElement;
	}
