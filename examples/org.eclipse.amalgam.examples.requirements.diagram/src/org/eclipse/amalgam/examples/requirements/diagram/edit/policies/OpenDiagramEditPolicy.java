...
import org.eclipse.amalgam.examples.requirements.diagram.part.RequirementsDiagramEditorUtil;
...
public class OpenDiagramEditPolicy extends OpenEditPolicy {
	...
	private static class OpenDiagramCommand extends
							...
							for (Iterator it = diagramFacet.eResource()
								...
								if (nextResource.isLoaded()
										&& !getEditingDomain().isReadOnly(
												nextResource)) {
									nextResource
											.save(RequirementsDiagramEditorUtil
													.getSaveOptions());
								}
							}
		...
		protected String getEditorID() {
			return "org.eclipse.amalgam.examples.scenario.diagram.part.ScenarioDiagramEditorID";
		}
	}
