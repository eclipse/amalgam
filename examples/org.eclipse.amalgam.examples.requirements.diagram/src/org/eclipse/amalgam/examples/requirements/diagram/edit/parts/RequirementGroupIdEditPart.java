 ...
 * @generated
 */
public class RequirementGroupIdEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public RequirementGroupIdEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new RequirementsParserProvider.HintAdapter(
					RequirementsElementTypes.RequirementGroup_2001,
