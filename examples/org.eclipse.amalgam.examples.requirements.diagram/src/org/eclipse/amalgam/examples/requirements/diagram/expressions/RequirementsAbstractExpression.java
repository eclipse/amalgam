 ...
 * @generated
 */
public abstract class RequirementsAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = RequirementsDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected RequirementsAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
