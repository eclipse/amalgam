...
import org.eclipse.amalgam.examples.requirements.diagram.edit.helpers.RequirementsBaseEditHelper;
 ...
 * @generated
 */
public class RequirementsBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	public Command getCommand(Request request) {
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(RequirementsVisualIDRegistry
	...
	protected Command getSemanticCommand(IEditCommandRequest request) {
		...
		if (elementType != null) {
			if (semanticCommand != null) {
				...
				completedRequest
						.setParameter(
								RequirementsBaseEditHelper.EDIT_POLICY_COMMAND,
								command);
			}
	...
	public static class LinkConstraints {
		 ...
		 * @generated
		 */
		public static boolean canCreateRequirementGroupRequirements_4001(
				RequirementGroup source, Requirement target) {
			if (source != null) {
			...
			return canExistRequirementGroupRequirements_4001(source, target);
		}

		/**
		 * @generated
		 */
		public static boolean canCreateRequirementChildren_4002(
			...
			return canExistRequirementChildren_4002(source, target);
		}

		/**
		 * @generated
		 */
		public static boolean canCreateRequirementDependencies_4003(
				Requirement source, Requirement target) {
			if (source != null) {
			...
			return canExistRequirementDependencies_4003(source, target);
		}

		/**
		 * @generated
		 */
		public static boolean canCreateRequirementGroupChildren_4004(
				RequirementGroup source, RequirementGroup target) {
			if (source != null) {
				if (source.getChildren().contains(target)) {
					return false;
				}
			...
			return canExistRequirementGroupChildren_4004(source, target);
		}

		/**
		 * @generated
		 */
		public static boolean canExistRequirementGroupRequirements_4001(
				RequirementGroup source, Requirement target) {
		 ...
		 * @generated
		 */
		public static boolean canExistRequirementChildren_4002(
				Requirement source, Requirement target) {
		 ...
		 * @generated
		 */
		public static boolean canExistRequirementDependencies_4003(
				Requirement source, Requirement target) {
		 ...
		 * @generated
		 */
		public static boolean canExistRequirementGroupChildren_4004(
				RequirementGroup source, RequirementGroup target) {
