 ...
 * @generated
 */
public class RequirementChildrenReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public RequirementChildrenReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return RequirementsBaseItemSemanticEditPolicy.LinkConstraints
				.canExistRequirementChildren_4002(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return RequirementsBaseItemSemanticEditPolicy.LinkConstraints
				.canExistRequirementChildren_4002(getOldSource(),
						getNewTarget());
	}
