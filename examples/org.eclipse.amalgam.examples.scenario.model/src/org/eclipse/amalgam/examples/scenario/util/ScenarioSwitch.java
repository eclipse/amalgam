 ...
 * </copyright>
 *
 * $Id: ScenarioSwitch.java,v 1.1 2008/11/14 17:38:46 rgronback Exp $
 */
...
public class ScenarioSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ScenarioPackage.PROCESS: {
				org.eclipse.amalgam.examples.scenario.Process process = (org.eclipse.amalgam.examples.scenario.Process)theEObject;
				T result = caseProcess(process);
				if (result == null) result = caseElement(process);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ScenarioPackage.ELEMENT: {
			...
			case ScenarioPackage.CONNECTION: {
			...
			case ScenarioPackage.SEQUENCE_FLOW: {
			...
			case ScenarioPackage.DATA_OBJECT: {
				...
				if (result == null) result = caseElement(dataObject);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ScenarioPackage.MESSAGE_FLOW: {
				MessageFlow messageFlow = (MessageFlow)theEObject;
				T result = caseMessageFlow(messageFlow);
				if (result == null) result = caseConnection(messageFlow);
				if (result == null) result = caseElement(messageFlow);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ScenarioPackage.ASSOCIATION: {
	 ...
	 * @generated
	 */
	public T caseProcess(org.eclipse.amalgam.examples.scenario.Process object) {
		return null;
	}
