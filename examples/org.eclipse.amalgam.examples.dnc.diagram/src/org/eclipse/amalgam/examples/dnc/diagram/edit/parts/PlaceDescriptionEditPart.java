 ...
 * @generated
 */
public class PlaceDescriptionEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public PlaceDescriptionEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new DncParserProvider.HintAdapter(
					DncElementTypes.Place_2005, getParserElement(), parserHint);
