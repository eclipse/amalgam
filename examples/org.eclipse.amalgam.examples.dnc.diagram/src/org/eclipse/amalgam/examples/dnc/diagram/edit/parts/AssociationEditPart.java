...
import org.eclipse.amalgam.examples.dnc.diagram.edit.policies.AssociationItemSemanticEditPolicy;
import org.eclipse.amalgam.examples.dnc.figures.BasicLink;
...
public class AssociationEditPart extends ConnectionNodeEditPart implements
	 ...
	 * @generated
	 */
	public BasicLink getPrimaryShape() {
		return (BasicLink) getFigure();
	}
