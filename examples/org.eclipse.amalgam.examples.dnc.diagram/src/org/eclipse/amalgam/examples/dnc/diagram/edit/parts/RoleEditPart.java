...
import org.eclipse.amalgam.examples.dnc.diagram.edit.policies.RoleCanonicalEditPolicy;
import org.eclipse.amalgam.examples.dnc.diagram.edit.policies.RoleItemSemanticEditPolicy;
...
public class RoleEditPart extends ShapeNodeEditPart {
							...
							if (request instanceof CreateViewAndElementRequest) {
								...
								if (type == DncElementTypes.Attribute_3001) {
									EditPart compartmentEditPart = getChildBySemanticHint(DncVisualIDRegistry
											.getType(RoleAttributesEditPart.VISUAL_ID));
								...
								if (type == DncElementTypes.Operation_3002) {
									EditPart compartmentEditPart = getChildBySemanticHint(DncVisualIDRegistry
											.getType(RoleOperationsEditPart.VISUAL_ID));
									return compartmentEditPart == null ? null
											: compartmentEditPart
													.getCommand(request);
								}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof RoleDescriptionEditPart) {
			((RoleDescriptionEditPart) childEditPart)
	...
	protected class PreferencePropertyChangeListener implements
		...
		public void propertyChange(PropertyChangeEvent event) {
			if (event.getProperty().equals(
					DiagramAppearancePreferencePage.PREF_ROLE_ARCHETYPE_COLOR)) {
