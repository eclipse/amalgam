...
import org.eclipse.amalgam.examples.dnc.diagram.edit.policies.OpenDiagramEditPolicy;
import org.eclipse.amalgam.examples.dnc.diagram.edit.policies.Package2CanonicalEditPolicy;
import org.eclipse.amalgam.examples.dnc.diagram.edit.policies.Package2ItemSemanticEditPolicy;
...
import org.eclipse.amalgam.examples.dnc.figures.PackageFigure;
					...
					public Command getCommand(Request request) {
						if (understandsRequest(request)) {
							if (request instanceof CreateViewAndElementRequest) {
								...
								if (type == DncElementTypes.Package_3003) {
									EditPart compartmentEditPart = getChildBySemanticHint(DncVisualIDRegistry
											.getType(PackagePackagesEditPart.VISUAL_ID));
