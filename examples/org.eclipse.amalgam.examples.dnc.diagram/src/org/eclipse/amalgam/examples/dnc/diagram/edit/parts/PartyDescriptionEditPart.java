 ...
 * @generated
 */
public class PartyDescriptionEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public PartyDescriptionEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new DncParserProvider.HintAdapter(
					DncElementTypes.Party_2004, getParserElement(), parserHint);
