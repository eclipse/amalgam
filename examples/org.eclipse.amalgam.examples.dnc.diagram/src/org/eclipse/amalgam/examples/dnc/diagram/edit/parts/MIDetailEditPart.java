...
import org.eclipse.amalgam.examples.dnc.diagram.edit.policies.MIDetailCanonicalEditPolicy;
import org.eclipse.amalgam.examples.dnc.diagram.edit.policies.MIDetailItemSemanticEditPolicy;
 ...
 * @generated
 */
public class MIDetailEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public MIDetailEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
							...
							if (request instanceof CreateViewAndElementRequest) {
								...
								if (type == DncElementTypes.Attribute_3001) {
									EditPart compartmentEditPart = getChildBySemanticHint(DncVisualIDRegistry
											.getType(MIDetailAttributesEditPart.VISUAL_ID));
								...
								if (type == DncElementTypes.Operation_3002) {
									EditPart compartmentEditPart = getChildBySemanticHint(DncVisualIDRegistry
											.getType(MIDetailOperationsEditPart.VISUAL_ID));
									return compartmentEditPart == null ? null
											: compartmentEditPart
													.getCommand(request);
								}
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new MIDetailItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new MIDetailCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof MIDetailNameEditPart) {
			((MIDetailNameEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureName());
			return true;
		}
		if (childEditPart instanceof MIDetailDescriptionEditPart) {
			((MIDetailDescriptionEditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DncVisualIDRegistry
				.getType(MIDetailNameEditPart.VISUAL_ID));
	}
