...
import org.eclipse.amalgam.examples.dnc.diagram.edit.policies.DescriptionCanonicalEditPolicy;
import org.eclipse.amalgam.examples.dnc.diagram.edit.policies.DescriptionItemSemanticEditPolicy;
 ...
 * @generated
 */
public class DescriptionEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public DescriptionEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new DescriptionItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new DescriptionCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DescriptionNameEditPart) {
			((DescriptionNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureName());
			return true;
		}
		if (childEditPart instanceof DescriptionDescriptionEditPart) {
			((DescriptionDescriptionEditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DncVisualIDRegistry
				.getType(DescriptionNameEditPart.VISUAL_ID));
	}
	...
	protected class PreferencePropertyChangeListener implements
		...
		public void propertyChange(PropertyChangeEvent event) {
			if (event.getProperty().equals(
					DiagramAppearancePreferencePage.PREF_DESC_ARCHETYPE_COLOR)) {
