...
public class RoleViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = DncVisualIDRegistry.getType(RoleEditPart.VISUAL_ID);
		...
		getViewService().createNode(eObjectAdapter, view,
				DncVisualIDRegistry.getType(RoleNameEditPart.VISUAL_ID),
				ViewUtil.APPEND, true, getPreferencesHint());
		getViewService().createNode(eObjectAdapter, view,
				DncVisualIDRegistry.getType(RoleDescriptionEditPart.VISUAL_ID),
				ViewUtil.APPEND, true, getPreferencesHint());
		getViewService().createNode(eObjectAdapter, view,
				DncVisualIDRegistry.getType(RoleAttributesEditPart.VISUAL_ID),
				ViewUtil.APPEND, true, getPreferencesHint());
		getViewService().createNode(eObjectAdapter, view,
				DncVisualIDRegistry.getType(RoleOperationsEditPart.VISUAL_ID),
				ViewUtil.APPEND, true, getPreferencesHint());
	}
}
