 ...
 * @generated
 */
public class PluginPointDescriptionEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public PluginPointDescriptionEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new DncParserProvider.HintAdapter(
					DncElementTypes.PluginPoint_2008, getParserElement(),
					parserHint);
