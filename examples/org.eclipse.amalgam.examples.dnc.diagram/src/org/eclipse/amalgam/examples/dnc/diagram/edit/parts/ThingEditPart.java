...
import org.eclipse.amalgam.examples.dnc.diagram.edit.policies.ThingCanonicalEditPolicy;
import org.eclipse.amalgam.examples.dnc.diagram.edit.policies.ThingItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ThingEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ThingEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
							...
							if (request instanceof CreateViewAndElementRequest) {
								...
								if (type == DncElementTypes.Attribute_3001) {
									EditPart compartmentEditPart = getChildBySemanticHint(DncVisualIDRegistry
											.getType(ThingAttributesEditPart.VISUAL_ID));
								...
								if (type == DncElementTypes.Operation_3002) {
									EditPart compartmentEditPart = getChildBySemanticHint(DncVisualIDRegistry
											.getType(ThingOperationsEditPart.VISUAL_ID));
									return compartmentEditPart == null ? null
											: compartmentEditPart
													.getCommand(request);
								}
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ThingItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new ThingCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ThingNameEditPart) {
			((ThingNameEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureName());
			return true;
		}
		if (childEditPart instanceof ThingDescriptionEditPart) {
			((ThingDescriptionEditPart) childEditPart)
