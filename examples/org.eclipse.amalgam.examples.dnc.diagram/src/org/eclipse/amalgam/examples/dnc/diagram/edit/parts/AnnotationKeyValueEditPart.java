 ...
 * @generated
 */
public class AnnotationKeyValueEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public AnnotationKeyValueEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new DncParserProvider.HintAdapter(
					DncElementTypes.Annotation_2010, getParserElement(),
					parserHint);
