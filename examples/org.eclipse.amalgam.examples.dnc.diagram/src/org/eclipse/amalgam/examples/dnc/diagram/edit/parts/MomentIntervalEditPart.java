...
import org.eclipse.amalgam.examples.dnc.diagram.edit.policies.MomentIntervalCanonicalEditPolicy;
import org.eclipse.amalgam.examples.dnc.diagram.edit.policies.MomentIntervalItemSemanticEditPolicy;
 ...
 * @generated
 */
public class MomentIntervalEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public MomentIntervalEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
							...
							if (request instanceof CreateViewAndElementRequest) {
								...
								if (type == DncElementTypes.Attribute_3001) {
									EditPart compartmentEditPart = getChildBySemanticHint(DncVisualIDRegistry
											.getType(MomentIntervalAttributesEditPart.VISUAL_ID));
								...
								if (type == DncElementTypes.Operation_3002) {
									EditPart compartmentEditPart = getChildBySemanticHint(DncVisualIDRegistry
											.getType(MomentIntervalOperationsEditPart.VISUAL_ID));
									return compartmentEditPart == null ? null
											: compartmentEditPart
													.getCommand(request);
								}
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new MomentIntervalItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new MomentIntervalCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof MomentIntervalNameEditPart) {
			((MomentIntervalNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureName());
			return true;
		}
		if (childEditPart instanceof MomentIntervalDescriptionEditPart) {
			((MomentIntervalDescriptionEditPart) childEditPart)
