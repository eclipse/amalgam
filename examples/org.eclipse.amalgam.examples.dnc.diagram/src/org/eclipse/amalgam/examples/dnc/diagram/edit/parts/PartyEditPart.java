...
import org.eclipse.amalgam.examples.dnc.diagram.edit.policies.PartyCanonicalEditPolicy;
import org.eclipse.amalgam.examples.dnc.diagram.edit.policies.PartyItemSemanticEditPolicy;
 ...
 * @generated
 */
public class PartyEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public PartyEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
							...
							if (request instanceof CreateViewAndElementRequest) {
								...
								if (type == DncElementTypes.Attribute_3001) {
									EditPart compartmentEditPart = getChildBySemanticHint(DncVisualIDRegistry
											.getType(PartyAttributesEditPart.VISUAL_ID));
								...
								if (type == DncElementTypes.Operation_3002) {
									EditPart compartmentEditPart = getChildBySemanticHint(DncVisualIDRegistry
											.getType(PartyOperationsEditPart.VISUAL_ID));
									return compartmentEditPart == null ? null
											: compartmentEditPart
													.getCommand(request);
								}
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new PartyItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new PartyCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PartyNameEditPart) {
			((PartyNameEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureName());
			return true;
		}
		if (childEditPart instanceof PartyDescriptionEditPart) {
			((PartyDescriptionEditPart) childEditPart)
