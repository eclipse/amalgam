 ...
 * @generated
 */
public class DescriptionDescriptionEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public DescriptionDescriptionEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new DncParserProvider.HintAdapter(
					DncElementTypes.Description_2007, getParserElement(),
					parserHint);
