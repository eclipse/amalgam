...
import org.eclipse.amalgam.examples.dnc.diagram.edit.policies.PluginPointCanonicalEditPolicy;
import org.eclipse.amalgam.examples.dnc.diagram.edit.policies.PluginPointItemSemanticEditPolicy;
 ...
 * @generated
 */
public class PluginPointEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public PluginPointEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new PluginPointItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new PluginPointCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PluginPointNameEditPart) {
			((PluginPointNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureName());
			return true;
		}
		if (childEditPart instanceof PluginPointDescriptionEditPart) {
			((PluginPointDescriptionEditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DncVisualIDRegistry
				.getType(PluginPointNameEditPart.VISUAL_ID));
	}
