 ...
 * @generated
 */
public class MomentIntervalViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = DncVisualIDRegistry
					.getType(MomentIntervalEditPart.VISUAL_ID);
		...
		getViewService().createNode(
				...
				view,
				DncVisualIDRegistry
						.getType(MomentIntervalDescriptionEditPart.VISUAL_ID),
				ViewUtil.APPEND, true, getPreferencesHint());
		getViewService().createNode(
				eObjectAdapter,
				view,
