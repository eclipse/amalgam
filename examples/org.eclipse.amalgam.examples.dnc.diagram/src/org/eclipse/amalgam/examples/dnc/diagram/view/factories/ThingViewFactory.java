 ...
 * @generated
 */
public class ThingViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = DncVisualIDRegistry.getType(ThingEditPart.VISUAL_ID);
		...
		getViewService().createNode(eObjectAdapter, view,
				DncVisualIDRegistry.getType(ThingNameEditPart.VISUAL_ID),
		...
		getViewService()
				.createNode(
						...
						view,
						DncVisualIDRegistry
								.getType(ThingDescriptionEditPart.VISUAL_ID),
						ViewUtil.APPEND, true, getPreferencesHint());
		getViewService().createNode(eObjectAdapter, view,
				DncVisualIDRegistry.getType(ThingAttributesEditPart.VISUAL_ID),
				ViewUtil.APPEND, true, getPreferencesHint());
		getViewService().createNode(eObjectAdapter, view,
				DncVisualIDRegistry.getType(ThingOperationsEditPart.VISUAL_ID),
				ViewUtil.APPEND, true, getPreferencesHint());
	}
}
