 ...
 * @generated
 */
public class DncNavigatorContentProvider implements ICommonContentProvider {
	 ...
	 * @generated
	 */
	public DncNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof DncNavigatorGroup) {
			DncNavigatorGroup group = (DncNavigatorGroup) parentElement;
			return group.getChildren();
		}

		if (parentElement instanceof DncNavigatorItem) {
			DncNavigatorItem navigatorItem = (DncNavigatorItem) parentElement;
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case PackageEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			DncNavigatorGroup links = new DncNavigatorGroup(
					Messages.NavigatorGroupName_Package_1000_links,
					"icons/linksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getChildrenByType(Collections
					.singleton(view), MomentIntervalEditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(view),
					MIDetailEditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(view),
			...
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(view),
					PartyEditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(view),
					PlaceEditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(view),
					ThingEditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(view),
					DescriptionEditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(view),
					PluginPointEditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(view),
		...
		case MomentIntervalEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			DncNavigatorGroup incominglinks = new DncNavigatorGroup(
					Messages.NavigatorGroupName_MomentInterval_2001_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			DncNavigatorGroup outgoinglinks = new DncNavigatorGroup(
					Messages.NavigatorGroupName_MomentInterval_2001_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getChildrenByType(Collections
					.singleton(view),
					MomentIntervalAttributesEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
					AttributeEditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(view),
					MomentIntervalOperationsEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
			...
			outgoinglinks.addChildren(createNavigatorItems(connectedViews,
					outgoinglinks, true));
			connectedViews = getIncomingLinksByType(
					Collections.singleton(view), Association2EditPart.VISUAL_ID);
			incominglinks.addChildren(createNavigatorItems(connectedViews,
					incominglinks, true));
			connectedViews = getOutgoingLinksByType(
					Collections.singleton(view), Association2EditPart.VISUAL_ID);
		...
		case MIDetailEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			DncNavigatorGroup incominglinks = new DncNavigatorGroup(
					Messages.NavigatorGroupName_MIDetail_2002_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			DncNavigatorGroup outgoinglinks = new DncNavigatorGroup(
					Messages.NavigatorGroupName_MIDetail_2002_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getChildrenByType(Collections
					.singleton(view), MIDetailAttributesEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
					AttributeEditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(view),
					MIDetailOperationsEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
					OperationEditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
		...
		case RoleEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			DncNavigatorGroup incominglinks = new DncNavigatorGroup(
					Messages.NavigatorGroupName_Role_2003_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			DncNavigatorGroup outgoinglinks = new DncNavigatorGroup(
					Messages.NavigatorGroupName_Role_2003_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getChildrenByType(Collections
					.singleton(view), RoleAttributesEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
					AttributeEditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(view),
					RoleOperationsEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
					OperationEditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
		...
		case PartyEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			DncNavigatorGroup incominglinks = new DncNavigatorGroup(
					Messages.NavigatorGroupName_Party_2004_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			DncNavigatorGroup outgoinglinks = new DncNavigatorGroup(
					Messages.NavigatorGroupName_Party_2004_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getChildrenByType(Collections
					.singleton(view), PartyAttributesEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
					AttributeEditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(view),
					PartyOperationsEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
					OperationEditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
		...
		case PlaceEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			DncNavigatorGroup incominglinks = new DncNavigatorGroup(
					Messages.NavigatorGroupName_Place_2005_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			DncNavigatorGroup outgoinglinks = new DncNavigatorGroup(
					Messages.NavigatorGroupName_Place_2005_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getChildrenByType(Collections
					.singleton(view), PlaceAttributesEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
					AttributeEditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(view),
					PlaceOperationsEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
					OperationEditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
		...
		case ThingEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			DncNavigatorGroup incominglinks = new DncNavigatorGroup(
					Messages.NavigatorGroupName_Thing_2006_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			DncNavigatorGroup outgoinglinks = new DncNavigatorGroup(
					Messages.NavigatorGroupName_Thing_2006_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getChildrenByType(Collections
					.singleton(view), ThingAttributesEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
					AttributeEditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(view),
					ThingOperationsEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
					OperationEditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
		...
		case DescriptionEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			DncNavigatorGroup incominglinks = new DncNavigatorGroup(
					Messages.NavigatorGroupName_Description_2007_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			DncNavigatorGroup outgoinglinks = new DncNavigatorGroup(
					Messages.NavigatorGroupName_Description_2007_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getChildrenByType(Collections
					.singleton(view), DescriptionAttributesEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
					AttributeEditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(view),
					DescriptionOperationsEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
					OperationEditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
		...
		case PluginPointEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			DncNavigatorGroup incominglinks = new DncNavigatorGroup(
					Messages.NavigatorGroupName_PluginPoint_2008_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			DncNavigatorGroup outgoinglinks = new DncNavigatorGroup(
					Messages.NavigatorGroupName_PluginPoint_2008_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getChildrenByType(Collections
					.singleton(view), PluginPointAttributesEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
					AttributeEditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(view),
					PluginPointOperationsEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
					OperationEditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
		...
		case Package2EditPart.VISUAL_ID: {
			...
			DncNavigatorGroup outgoinglinks = new DncNavigatorGroup(
					...
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getChildrenByType(Collections
					.singleton(view), PackagePackagesEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
		...
		case AnnotationEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			DncNavigatorGroup incominglinks = new DncNavigatorGroup(
					Messages.NavigatorGroupName_Annotation_2010_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
		...
		case AttributeEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			DncNavigatorGroup outgoinglinks = new DncNavigatorGroup(
					Messages.NavigatorGroupName_Attribute_3001_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
		...
		case OperationEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			DncNavigatorGroup outgoinglinks = new DncNavigatorGroup(
					Messages.NavigatorGroupName_Operation_3002_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getOutgoingLinksByType(Collections
					.singleton(view),
					AnnotatedElementAnnotationsEditPart.VISUAL_ID);
		...
		case Package3EditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			DncNavigatorGroup outgoinglinks = new DncNavigatorGroup(
					Messages.NavigatorGroupName_Package_3003_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getOutgoingLinksByType(Collections
					.singleton(view),
					AnnotatedElementAnnotationsEditPart.VISUAL_ID);
		...
		case AssociationEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			DncNavigatorGroup target = new DncNavigatorGroup(
					Messages.NavigatorGroupName_Association_4001_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			DncNavigatorGroup source = new DncNavigatorGroup(
			...
			connectedViews = getLinksSourceByType(Collections.singleton(view),
					MomentIntervalEditPart.VISUAL_ID);
		...
		case ClassSuperclassesEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			DncNavigatorGroup target = new DncNavigatorGroup(
					Messages.NavigatorGroupName_ClassSuperclasses_4002_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			DncNavigatorGroup source = new DncNavigatorGroup(
					Messages.NavigatorGroupName_ClassSuperclasses_4002_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getLinksTargetByType(Collections
					.singleton(view), MomentIntervalEditPart.VISUAL_ID);
			target.addChildren(createNavigatorItems(connectedViews, target,
		...
		case AnnotatedElementAnnotationsEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			DncNavigatorGroup target = new DncNavigatorGroup(
					Messages.NavigatorGroupName_AnnotatedElementAnnotations_4004_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			DncNavigatorGroup source = new DncNavigatorGroup(
					Messages.NavigatorGroupName_AnnotatedElementAnnotations_4004_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getLinksTargetByType(Collections
					.singleton(view), AnnotationEditPart.VISUAL_ID);
			target.addChildren(createNavigatorItems(connectedViews, target,
					true));
			connectedViews = getLinksSourceByType(Collections.singleton(view),
					MomentIntervalEditPart.VISUAL_ID);
	...
	private Collection getLinksSourceByType(Collection edges, int visualID) {
		Collection result = new ArrayList();
		String type = DncVisualIDRegistry.getType(visualID);
	...
	private Collection createNavigatorItems(Collection views, Object parent,
		...
		Collection result = new ArrayList();
		for (Iterator it = views.iterator(); it.hasNext();) {
			result.add(new DncNavigatorItem((View) it.next(), parent, isLeafs));
		}
		return result;
	}
	...
	public Object getParent(Object element) {
		if (element instanceof DncAbstractNavigatorItem) {
			DncAbstractNavigatorItem abstractNavigatorItem = (DncAbstractNavigatorItem) element;
