...
import org.eclipse.amalgam.examples.dnc.diagram.part.DncDiagramEditor;
 ...
 * @generated
 */
public class DncNavigatorActionProvider extends CommonActionProvider {
	...
	private class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof DncNavigatorItem) {
					selectedElement = ((DncNavigatorItem) selectedElement)
							.getView();
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, DncDiagramEditor.ID);
