...
public abstract class RequirementsEditorPart extends EditorPart implements IMenuListener, IEditingDomainProvider {
	  ...
	  public void doSave(IProgressMonitor monitor) {
	    // nothing to do here Ð this is handled by the parent editor
	  }
