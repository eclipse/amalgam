 ...
 * </copyright>
 *
 * $Id: RequirementsFactoryImpl.java,v 1.1 2008/11/14 17:35:37 rgronback Exp $
 */
...
public class RequirementsFactoryImpl extends EFactoryImpl implements RequirementsFactory {
	...
	public static RequirementsFactory init() {
		try {
			RequirementsFactory theRequirementsFactory = (RequirementsFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.eclipse.org/2008/requirements"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case RequirementsPackage.MODEL: return createModel();
			...
			case RequirementsPackage.REQUIREMENT_GROUP: return createRequirementGroup();
			default:
