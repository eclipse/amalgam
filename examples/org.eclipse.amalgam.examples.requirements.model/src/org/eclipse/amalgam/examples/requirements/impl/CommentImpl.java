 ...
 * </copyright>
 *
 * $Id: CommentImpl.java,v 1.1 2008/11/14 17:35:37 rgronback Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.amalgam.examples.requirements.impl.CommentImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link org.eclipse.amalgam.examples.requirements.impl.CommentImpl#getBody <em>Body</em>}</li>
 *   <li>{@link org.eclipse.amalgam.examples.requirements.impl.CommentImpl#getAuthor <em>Author</em>}</li>
 *   <li>{@link org.eclipse.amalgam.examples.requirements.impl.CommentImpl#getCreated <em>Created</em>}</li>
 *   <li>{@link org.eclipse.amalgam.examples.requirements.impl.CommentImpl#getChildren <em>Children</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CommentImpl extends EObjectImpl implements Comment {
	...
	public EList<Comment> getChildren() {
		if (children == null) {
			children = new EObjectContainmentEList<Comment>(Comment.class, this, RequirementsPackage.COMMENT__CHILDREN);
		}
		return children;
	}
