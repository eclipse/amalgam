 ...
 * </copyright>
 *
 * $Id: ReferenceItemProvider.java,v 1.1 2008/11/14 17:34:52 rgronback Exp $
 */
...
/**
 * This is the item provider adapter for a {@link org.eclipse.amalgam.examples.oocore.Reference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OocorePackage.Literals.REFERENCE__CONTAINMENT,
				 true,
				 false,
				 false,
	...
	protected void addBidirectionalPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Reference_bidirectional_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Reference_bidirectional_feature", "_UI_Reference_type"),
				 OocorePackage.Literals.REFERENCE__BIDIRECTIONAL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OocorePackage.Literals.REFERENCE__OPPOSITE,
				 true,
				 false,
				 true,
				 null,
