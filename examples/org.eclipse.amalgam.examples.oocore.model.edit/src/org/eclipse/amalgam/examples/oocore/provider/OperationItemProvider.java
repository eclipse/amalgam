 ...
 * </copyright>
 *
 * $Id: OperationItemProvider.java,v 1.1 2008/11/14 17:34:52 rgronback Exp $
 */
...
/**
 * This is the item provider adapter for a {@link org.eclipse.amalgam.examples.oocore.Operation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OperationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Operation_owner_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Operation_owner_feature", "_UI_Operation_type"),
				 OocorePackage.Literals.OPERATION__OWNER,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(OocorePackage.Literals.OPERATION__PARAMETERS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(OocorePackage.Literals.OPERATION__PARAMETERS,
				 OocoreFactory.eINSTANCE.createParameter()));
	}
