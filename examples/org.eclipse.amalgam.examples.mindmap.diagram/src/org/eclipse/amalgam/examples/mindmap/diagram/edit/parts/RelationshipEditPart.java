...
import org.eclipse.amalgam.examples.mindmap.diagram.edit.policies.RelationshipItemSemanticEditPolicy;
...
public class RelationshipEditPart extends ConnectionNodeEditPart implements
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof RelationshipTypeEditPart) {
			((RelationshipTypeEditPart) childEditPart)
					.setLabel(getPrimaryShape()
