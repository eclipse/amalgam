...
import org.eclipse.amalgam.examples.mindmap.diagram.view.factories.MapViewFactory;
import org.eclipse.amalgam.examples.mindmap.diagram.view.factories.Relationship2ViewFactory;
import org.eclipse.amalgam.examples.mindmap.diagram.view.factories.Relationship3ViewFactory;
import org.eclipse.amalgam.examples.mindmap.diagram.view.factories.RelationshipName2ViewFactory;
import org.eclipse.amalgam.examples.mindmap.diagram.view.factories.RelationshipName3ViewFactory;
import org.eclipse.amalgam.examples.mindmap.diagram.view.factories.RelationshipNameViewFactory;
import org.eclipse.amalgam.examples.mindmap.diagram.view.factories.RelationshipType2ViewFactory;
import org.eclipse.amalgam.examples.mindmap.diagram.view.factories.RelationshipType3ViewFactory;
import org.eclipse.amalgam.examples.mindmap.diagram.view.factories.RelationshipTypeViewFactory;
import org.eclipse.amalgam.examples.mindmap.diagram.view.factories.RelationshipViewFactory;
import org.eclipse.amalgam.examples.mindmap.diagram.view.factories.Topic2ViewFactory;
import org.eclipse.amalgam.examples.mindmap.diagram.view.factories.TopicName2ViewFactory;
import org.eclipse.amalgam.examples.mindmap.diagram.view.factories.TopicNameViewFactory;
import org.eclipse.amalgam.examples.mindmap.diagram.view.factories.TopicSubtopicsViewFactory;
import org.eclipse.amalgam.examples.mindmap.diagram.view.factories.TopicViewFactory;
...
public class MindmapViewProvider extends AbstractViewProvider {
		...
		if (semanticHint == null) {
			...
			if (elementType != null) {
				...
				case TopicName2EditPart.VISUAL_ID:
					if (Topic2EditPart.VISUAL_ID != MindmapVisualIDRegistry
							.getVisualID(containerView)
							|| containerView.getElement() != domainElement) {
						return null; // wrong container
					}
	...
	protected Class getNodeViewClass(View containerView, int visualID) {
		...
		case Topic2EditPart.VISUAL_ID:
			return Topic2ViewFactory.class;
		case TopicName2EditPart.VISUAL_ID:
			return TopicName2ViewFactory.class;
		case RelationshipNameEditPart.VISUAL_ID:
			return RelationshipNameViewFactory.class;
		case RelationshipTypeEditPart.VISUAL_ID:
			return RelationshipTypeViewFactory.class;
		case RelationshipName2EditPart.VISUAL_ID:
			return RelationshipName2ViewFactory.class;
		case RelationshipType2EditPart.VISUAL_ID:
			return RelationshipType2ViewFactory.class;
		case RelationshipName3EditPart.VISUAL_ID:
			return RelationshipName3ViewFactory.class;
		case RelationshipType3EditPart.VISUAL_ID:
			return RelationshipType3ViewFactory.class;
		}
		return null;
	}
