...
import org.eclipse.amalgam.examples.scenario.diagram.edit.commands.Event7CreateCommand;
import org.eclipse.amalgam.examples.scenario.diagram.edit.commands.Event8CreateCommand;
 ...
 * @generated
 */
public class TaskItemSemanticEditPolicy extends
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (ScenarioElementTypes.Event_3001 == req.getElementType()) {
			if (req.getContainmentFeature() == null) {
				req.setContainmentFeature(ScenarioPackage.eINSTANCE
						.getTask_Events());
			}
			return getGEFWrapper(new Event7CreateCommand(req));
		}
		if (ScenarioElementTypes.Event_3002 == req.getElementType()) {
			if (req.getContainmentFeature() == null) {
				req.setContainmentFeature(ScenarioPackage.eINSTANCE
						.getTask_Events());
			}
			return getGEFWrapper(new Event8CreateCommand(req));
		}
	...
	protected void addDestroyChildNodesCommand(CompoundCommand cmd) {
		...
		for (Iterator it = view.getChildren().iterator(); it.hasNext();) {
			...
			switch (ScenarioVisualIDRegistry.getVisualID(node)) {
