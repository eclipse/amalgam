...
import org.eclipse.amalgam.examples.scenario.diagram.part.Messages;
 ...
 * @generated
 */
public class ScenarioNavigatorActionProvider extends CommonActionProvider {
	...
	private class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof ScenarioNavigatorItem) {
					selectedElement = ((ScenarioNavigatorItem) selectedElement)
							.getView();
				...
				if (selectedElement instanceof Diagram) {
					...
					if (ProcessEditPart.MODEL_ID
							.equals(ScenarioVisualIDRegistry
									.getModelID(diagram))) {
						myDiagram = diagram;
					}
				}
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, ScenarioDiagramEditor.ID);
