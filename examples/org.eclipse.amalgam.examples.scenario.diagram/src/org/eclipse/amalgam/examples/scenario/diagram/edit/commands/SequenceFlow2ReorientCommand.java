 ...
 * @generated
 */
public class SequenceFlow2ReorientCommand extends EditElementCommand {
	...
	protected boolean canReorientSource() {
		...
		return ScenarioBaseItemSemanticEditPolicy.LinkConstraints
				.canExistSequenceFlow_4004(container, getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		Process container = (Process) getLink().eContainer();
		return ScenarioBaseItemSemanticEditPolicy.LinkConstraints
				.canExistSequenceFlow_4004(container, source, getNewTarget());
	}
