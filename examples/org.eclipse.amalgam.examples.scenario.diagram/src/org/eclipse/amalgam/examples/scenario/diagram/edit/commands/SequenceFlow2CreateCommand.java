 ...
 * @generated
 */
public class SequenceFlow2CreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public SequenceFlow2CreateCommand(CreateRelationshipRequest request,
			EObject source, EObject target) {
		super(request);
		this.source = source;
		this.target = target;
		if (request.getContainmentFeature() == null) {
			setContainmentFeature(ScenarioPackage.eINSTANCE
					.getProcess_Elements());
		}
	...
	public boolean canExecute() {
		...
		return ScenarioBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateSequenceFlow_4004(getContainer(), getSource(),
						getTarget());
	}
	...
	protected EObject doDefaultElementCreation() {
		SequenceFlow newElement = ScenarioFactory.eINSTANCE
				.createSequenceFlow();
		getContainer().getElements().add(newElement);
		newElement.setSource(getSource());
		newElement.setTarget(getTarget());
		ScenarioElementTypes.init_SequenceFlow_4004(newElement);
		return newElement;
	}
