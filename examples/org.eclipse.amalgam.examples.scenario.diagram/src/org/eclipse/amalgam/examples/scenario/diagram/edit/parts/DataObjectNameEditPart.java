...
public class DataObjectNameEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				ScenarioVisualIDRegistry
						.getType(org.eclipse.amalgam.examples.scenario.diagram.edit.parts.DataObjectNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public DataObjectNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new ScenarioParserProvider.HintAdapter(
					ScenarioElementTypes.DataObject_2001, getParserElement(),
					parserHint);
