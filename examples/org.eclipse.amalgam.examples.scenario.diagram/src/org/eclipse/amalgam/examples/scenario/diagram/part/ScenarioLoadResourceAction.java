 ...
 * @generated
 */
public class ScenarioLoadResourceAction implements IObjectActionDelegate {

	/**
	 * @generated
	 */
	private ProcessEditPart mySelectedElement;
	...
	public void selectionChanged(IAction action, ISelection selection) {
		...
		if (selection instanceof IStructuredSelection) {
			...
			if (structuredSelection.size() == 1
					&& structuredSelection.getFirstElement() instanceof ProcessEditPart) {
				mySelectedElement = (ProcessEditPart) structuredSelection
						.getFirstElement();
			}
		}
