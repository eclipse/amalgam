...
public class MessageFlowNameEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				ScenarioVisualIDRegistry
						.getType(org.eclipse.amalgam.examples.scenario.diagram.edit.parts.MessageFlowNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public MessageFlowNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new ScenarioParserProvider.HintAdapter(
					ScenarioElementTypes.MessageFlow_4003, getParserElement(),
					parserHint);
