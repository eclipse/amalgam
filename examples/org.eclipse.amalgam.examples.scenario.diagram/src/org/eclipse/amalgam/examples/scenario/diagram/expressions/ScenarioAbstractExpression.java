 ...
 * @generated
 */
public abstract class ScenarioAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = ScenarioDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected ScenarioAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
