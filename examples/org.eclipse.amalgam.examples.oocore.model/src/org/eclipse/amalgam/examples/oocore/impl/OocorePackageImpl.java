 ...
 * </copyright>
 *
 * $Id: OocorePackageImpl.java,v 1.1 2008/11/14 17:34:32 rgronback Exp $
 */
 ...
 * @generated
 */
public class OocorePackageImpl extends EPackageImpl implements OocorePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see org.eclipse.amalgam.examples.oocore.OocorePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private OocorePackageImpl() {
		super(eNS_URI, OocoreFactory.eINSTANCE);
	}
	 ...
	 * @generated
	 */
	public static OocorePackage init() {
		if (isInited) return (OocorePackage)EPackage.Registry.INSTANCE.getEPackage(OocorePackage.eNS_URI);

		// Obtain or create and register package
		OocorePackageImpl theOocorePackage = (OocorePackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof OocorePackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new OocorePackageImpl());

		isInited = true;

		// Create package meta-data objects
		theOocorePackage.createPackageContents();

		// Initialize created meta-data
		theOocorePackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theOocorePackage.freeze();

		return theOocorePackage;
	}
	 ...
	 * @generated
	 */
	public EAttribute getClass_Interface() {
	 ...
	 * @generated
	 */
	public EAttribute getDatatype_DefaultLiteral() {
	 ...
	 * @generated
	 */
	public EAttribute getStructuralFeature_Required() {
	 ...
	 * @generated
	 */
	public EAttribute getReference_Bidirectional() {
	 ...
	 * @generated
	 */
	public OocoreFactory getOocoreFactory() {
		return (OocoreFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(classEClass, CLASS__INTERFACE);
		createEReference(classEClass, CLASS__OPERATIONS);

		datatypeEClass = createEClass(DATATYPE);
		createEAttribute(datatypeEClass, DATATYPE__DEFAULT_LITERAL);

		structuralFeatureEClass = createEClass(STRUCTURAL_FEATURE);
		createEAttribute(structuralFeatureEClass, STRUCTURAL_FEATURE__REQUIRED);
		...
		createEAttribute(referenceEClass, REFERENCE__BIDIRECTIONAL);
	...
	public void initializePackageContents() {
		...
		classifierEClass.getESuperTypes().add(this.getPackageableElement());
		...
		initEReference(getPackageableElement_Package(), this.getPackage(), this.getPackage_Contents(), "package", null, 0, 1, PackageableElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEClass(packageEClass, org.eclipse.amalgam.examples.oocore.Package.class, "Package", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPackage_Contents(), this.getPackageableElement(), this.getPackageableElement_Package(), "contents", null, 0, -1, org.eclipse.amalgam.examples.oocore.Package.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(classifierEClass, Classifier.class, "Classifier", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(classEClass, org.eclipse.amalgam.examples.oocore.Class.class, "Class", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getClass_Superclasses(), this.getClass_(), this.getClass_Subclasses(), "superclasses", null, 0, -1, org.eclipse.amalgam.examples.oocore.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getClass_Subclasses(), this.getClass_(), this.getClass_Superclasses(), "subclasses", null, 0, -1, org.eclipse.amalgam.examples.oocore.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getClass_Features(), this.getStructuralFeature(), this.getStructuralFeature_Owner(), "features", null, 0, -1, org.eclipse.amalgam.examples.oocore.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getClass_Abstract(), ecorePackage.getEBoolean(), "abstract", "false", 1, 1, org.eclipse.amalgam.examples.oocore.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getClass_Interface(), ecorePackage.getEBoolean(), "interface", "false", 1, 1, org.eclipse.amalgam.examples.oocore.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getClass_Operations(), this.getOperation(), null, "operations", null, 0, -1, org.eclipse.amalgam.examples.oocore.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(datatypeEClass, Datatype.class, "Datatype", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getDatatype_DefaultLiteral(), ecorePackage.getEString(), "defaultLiteral", null, 0, 1, Datatype.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getStructuralFeature_Required(), ecorePackage.getEBoolean(), "required", null, 0, 1, StructuralFeature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getStructuralFeature_Owner(), this.getClass_(), this.getClass_Features(), "owner", null, 1, 1, StructuralFeature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getOperation_Owner(), this.getClass_(), null, "owner", null, 1, 1, Operation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getReference_Containment(), ecorePackage.getEBoolean(), "containment", null, 0, 1, Reference.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getReference_Bidirectional(), ecorePackage.getEBoolean(), "bidirectional", null, 0, 1, Reference.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTypedElement_UpperBound(), ecorePackage.getEInt(), "upperBound", "1", 0, 1, TypedElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTypedElement_LowerBound(), ecorePackage.getEInt(), "lowerBound", "0", 0, 1, TypedElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
