 ...
 */
public class RequirementsMultiPageActionBarContributor extends
	...
	private IPropertyListener myEditorPropertyChangeListener = new IPropertyListener() {
		...
		public void propertyChanged(Object source, int propId) {
			if (myActiveEditorActionBars != null) {
				if (myActiveEditorActionBars.getContributor() instanceof RequirementsActionBarContributor) {
					((RequirementsActionBarContributor) myActiveEditorActionBars.getContributor()).update();
				}
			}
		}
	};
	...
	public void setActivePage(IEditorPart activeEditor) {
		if (activeEditor instanceof RequirementsDiagramEditor) {
	...
	public SubActionBarsExt getTreeSubActionBars() {
		if (myTreeSubActionBars == null) {
			myTreeSubActionBars = new SubActionBarsExt(getPage(),
					myActionBars2, new RequirementsActionBarContributor(),
	...
	public SubActionBarsExt getDiagramSubActionBars() {
		if (myDiagramSubActionBars == null) {
			myDiagramSubActionBars = new SubActionBarsExt(getPage(),
					myActionBars2,
					new RequirementsDiagramActionBarContributor(),
