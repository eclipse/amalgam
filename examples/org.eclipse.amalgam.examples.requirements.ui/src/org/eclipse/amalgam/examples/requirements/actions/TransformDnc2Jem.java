...
public class TransformDnc2Jem implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		try {
			...
			if (source == null) {
				...
				URI transfUri = URI.createURI("platform:/plugin/org.eclipse.amalgam.examples.requirements.ui/transformations/dnc2jee.qvto"); //$NON-NLS-1$
