...
public class TransformMindmap2Requirements implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		try {
			...
			if (source == null) {
				...
				URI transfUri = URI.createURI("platform:/plugin/org.eclipse.amalgam.examples.requirements.ui/transformations/mindmap2requirements.qvto"); //$NON-NLS-1$
