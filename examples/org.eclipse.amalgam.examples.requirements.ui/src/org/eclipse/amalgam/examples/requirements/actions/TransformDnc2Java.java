...
public class TransformDnc2Java implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		try {
			...
			if (source == null) {
				...
				URL url = FileLocator.toFileURL(new URL("platform:/plugin/org.eclipse.amalgam.examples.requirements.ui/templates/dnc2java.mwe"));
