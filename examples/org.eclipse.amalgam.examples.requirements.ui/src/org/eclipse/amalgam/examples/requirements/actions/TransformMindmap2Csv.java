...
public class TransformMindmap2Csv implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		try {
			...
			if (source == null) {
				...
				URL url = FileLocator.toFileURL(new URL("platform:/plugin/org.eclipse.amalgam.examples.requirements.ui/templates/mindmap2csv.mwe"));
