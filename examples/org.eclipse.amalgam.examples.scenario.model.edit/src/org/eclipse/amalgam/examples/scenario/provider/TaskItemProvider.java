 ...
 * </copyright>
 *
 * $Id: TaskItemProvider.java,v 1.1 2008/11/14 17:39:11 rgronback Exp $
 */
...
/**
 * This is the item provider adapter for a {@link org.eclipse.amalgam.examples.scenario.Task} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TaskItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ScenarioPackage.Literals.TASK__EVENTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Task.class)) {
			case ScenarioPackage.TASK__EVENTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ScenarioPackage.Literals.TASK__EVENTS,
