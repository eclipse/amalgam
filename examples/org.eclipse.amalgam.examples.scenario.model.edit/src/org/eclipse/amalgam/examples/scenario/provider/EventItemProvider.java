 ...
 * </copyright>
 *
 * $Id: EventItemProvider.java,v 1.1 2008/11/14 17:39:10 rgronback Exp $
 */
...
/**
 * This is the item provider adapter for a {@link org.eclipse.amalgam.examples.scenario.Event} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Event_eventType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Event_eventType_feature", "_UI_Event_type"),
				 ScenarioPackage.Literals.EVENT__EVENT_TYPE,
				 true,
				 false,
				 false,
	...
	protected void addTriggerTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Event_triggerType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Event_triggerType_feature", "_UI_Event_type"),
				 ScenarioPackage.Literals.EVENT__TRIGGER_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
