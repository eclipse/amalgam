 ...
 * </copyright>
 *
 * $Id: CommentItemProvider.java,v 1.1 2008/11/14 17:36:05 rgronback Exp $
 */
...
/**
 * This is the item provider adapter for a {@link org.eclipse.amalgam.examples.requirements.Comment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CommentItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Comment_subject_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Comment_subject_feature", "_UI_Comment_type"),
				 RequirementsPackage.Literals.COMMENT__SUBJECT,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RequirementsPackage.Literals.COMMENT__BODY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RequirementsPackage.Literals.COMMENT__AUTHOR,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RequirementsPackage.Literals.COMMENT__CREATED,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RequirementsPackage.Literals.COMMENT__CHILDREN);
		}
	...
	public String getText(Object object) {
		...
		sb.append(((Comment)object).getCreated());
		sb.append(" [");
		sb.append(((Comment)object).getAuthor());
		sb.append("] ");
		sb.append(((Comment)object).getSubject());
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Comment.class)) {
			...
			case RequirementsPackage.COMMENT__CREATED:
				...
				return;
			case RequirementsPackage.COMMENT__CHILDREN:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RequirementsPackage.Literals.COMMENT__CHILDREN,
