 ...
 *
 * $Id: VirtualMachineItemProvider.java,v 1.1 2008/11/24 20:38:53 rgronback Exp $
 */
...
/**
 * This is the item provider adapter for a {@link org.eclipse.amalgam.releng.product.VirtualMachine} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VirtualMachineItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addMacosPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Macos feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addMacosPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VirtualMachine_macos_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VirtualMachine_macos_feature", "_UI_VirtualMachine_type"),
				 ProductPackage.Literals.VIRTUAL_MACHINE__MACOS,
				 true,
				 false,
				 false,
	...
	protected void addSolarisPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VirtualMachine_solaris_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VirtualMachine_solaris_feature", "_UI_VirtualMachine_type"),
				 ProductPackage.Literals.VIRTUAL_MACHINE__SOLARIS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addLinuxPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VirtualMachine_linux_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VirtualMachine_linux_feature", "_UI_VirtualMachine_type"),
				 ProductPackage.Literals.VIRTUAL_MACHINE__LINUX,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addWindowsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VirtualMachine_windows_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VirtualMachine_windows_feature", "_UI_VirtualMachine_type"),
				 ProductPackage.Literals.VIRTUAL_MACHINE__WINDOWS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((VirtualMachine)object).getMacos();
