 ...
 *
 * $Id: ImageItemProvider.java,v 1.1 2008/11/24 20:38:53 rgronback Exp $
 */
...
/**
 * This is the item provider adapter for a {@link org.eclipse.amalgam.releng.product.Image} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ImageItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Image_path_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Image_path_feature", "_UI_Image_type"),
				 ProductPackage.Literals.IMAGE__PATH,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Image)object).getPath();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Image.class)) {
			case ProductPackage.IMAGE__PATH:
