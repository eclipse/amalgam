...
scp -rp "$WORKSPACE"/features/org.eclipse.amalgam.update/target/repository/* "$SSH_ACCOUNT:$TARGET_DIR"
...
<repository name='Modeling Amalgam' type='org.eclipse.equinox.internal.p2.artifact.repository.CompositeArtifactRepository' version='1.0.0'>
  <properties size='1'>
    <property name='p2.timestamp' value='$P2_TIMESTAMP'/>
  </properties>
  <children size='1'>
    <child location='http://download.eclipse.org/modeling/amalgam/updates/$TO'/>
  </children>
</repository>
EOF
...
<repository name='Modeling Amalgam' type='org.eclipse.equinox.internal.p2.metadata.repository.CompositeMetadataRepository' version='1.0.0'>
  <properties size='1'>
    <property name='p2.timestamp' value='$P2_TIMESTAMP'/>
  </properties>
  <children size='1'>
